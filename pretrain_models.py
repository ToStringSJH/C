...
class Enc_VAE(nn.Module):
    def __init__(self, channel, output_dim, windowSize):
        ...
        self.conv1 = ConvBNRelu3D(1, 8, kernel_size=(7,3,3))
        self.conv2 = ConvBNRelu3D(8, 16, kernel_size=(5,3,3)) 
        self.conv3 = ConvBNRelu3D(16, 32, kernel_size=(3,3,3))
        ...
        self.mu = nn.Linear(512, output_dim)  # 128维潜空间
